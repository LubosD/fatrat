...
JArray::JArray(jarray arr) : JObject(arr) {}

JArray::JArray(jobject arr) : JObject(arr) {}
...
JArray JArray::createObjectArray(size_t length, JClass type,
...
jarray JArray::getLocalRef() { return (jarray)JObject::getLocalRef(); }
