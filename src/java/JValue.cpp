...
JValue::JValue(bool b)
	: m_bHasObject(false)
{
	m_value.z = b;
}

JValue::JValue(char c)
	: m_bHasObject(false)
{
	m_value.b = c;
}

JValue::JValue(wchar_t c)
	: m_bHasObject(false)
{
	m_value.c = c;
}

JValue::JValue(short s)
	: m_bHasObject(false)
{
	m_value.s = s;
}
...
JValue::JValue(long long l)
	: m_bHasObject(false)
{
	m_value.j = l;
}

JValue::JValue(float f)
	: m_bHasObject(false)
{
	m_value.f = f;
}

JValue::JValue(double d)
	: m_bHasObject(false)
{
	m_value.d = d;
}
