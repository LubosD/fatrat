...
JString::JString(const QString& str) { *this = str.toUtf8(); }

JString::JString(const QByteArray& str) { *this = str.constData(); }
...
JString::operator jstring() const { return (jstring)m_object; }
...
JString::operator QString() const { return str(); }
