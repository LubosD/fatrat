 ...
 * Command line was: qdbusxml2cpp -p NotificationsProxy -a NotificationsAdaptor
...
class OrgFreedesktopNotificationsInterface : public QDBusAbstractInterface {
 ...
 public:
  OrgFreedesktopNotificationsInterface(const QString &service,
                                       const QString &path,
 ...
 public Q_SLOTS:  // METHODS
  ...
  inline QDBusPendingReply<QStringList> GetCapabilities() {
    QList<QVariant> argumentList;
    return asyncCallWithArgumentList(QLatin1String("GetCapabilities"),
                                     argumentList);
  }
  ...
  GetServerInformation() {
    QList<QVariant> argumentList;
    return asyncCallWithArgumentList(QLatin1String("GetServerInformation"),
                                     argumentList);
  }
  inline QDBusReply<QString> GetServerInformation(
      QString &return_vendor, QString &return_version,
      QString &return_spec_version) {
    QList<QVariant> argumentList;
    QDBusMessage reply = callWithArgumentList(
        QDBus::Block, QLatin1String("GetServerInformation"), argumentList);
  ...
  inline QDBusPendingReply<uint> Notify(const QString &app_name, uint id,
    ...
    QList<QVariant> argumentList;
    argumentList << QVariant::fromValue(app_name) << QVariant::fromValue(id)
                 << QVariant::fromValue(icon) << QVariant::fromValue(summary)
