...
class OrgKdeKNotifyInterface : public QDBusAbstractInterface {
  Q_OBJECT
 public:
  static inline const char *staticInterfaceName() { return "org.kde.KNotify"; }

 public:
  OrgKdeKNotifyInterface(const QString &service, const QString &path,
 ...
 public Q_SLOTS:  // METHODS
  inline QDBusPendingReply<> closeNotification(int id) {
    ...
    return asyncCallWithArgumentList(QLatin1String("closeNotification"),
                                     argumentList);
  }

  inline QDBusPendingReply<int> event(const QString &event,
                                      const QString &fromApp,
                                      const QVariantList &contexts,
                                      const QString &title, const QString &text,
                                      const QByteArray &pixmap,
                                      const QStringList &actions, int timeout,
                                      qlonglong winId) {
    QList<QVariant> argumentList;
    argumentList << QVariant::fromValue(event) << QVariant::fromValue(fromApp)
                 << QVariant::fromValue(contexts) << QVariant::fromValue(title)
                 << QVariant::fromValue(text) << QVariant::fromValue(pixmap)
                 << QVariant::fromValue(actions) << QVariant::fromValue(timeout)
  ...
  inline QDBusPendingReply<> reconfigure() {
    QList<QVariant> argumentList;
    return asyncCallWithArgumentList(QLatin1String("reconfigure"),
                                     argumentList);
  }
  ...
  inline QDBusPendingReply<> update(int id, const QString &title,
                                    const QString &text,
                                    const QByteArray &pixmap,
                                    const QStringList &actions) {
    QList<QVariant> argumentList;
    argumentList << QVariant::fromValue(id) << QVariant::fromValue(title)
                 << QVariant::fromValue(text) << QVariant::fromValue(pixmap)
