...
void CaptchaQtDlg::updateInfo() {
  labelInfo->setText(tr("Please re-type the characters seen in the picture "
                        "below. This dialog will be automatically dismissed in "
                        "<b>%1 seconds</b> (queue blocking prevention).")
                         .arg(m_nSecondsLeft));
}
...
void CaptchaQtDlg::textChanged() { m_nSecondsLeft = 30; }
