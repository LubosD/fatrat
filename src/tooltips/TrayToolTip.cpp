...
TrayToolTip::TrayToolTip(QWidget* parent) : BaseToolTip(0, parent) {
...
void TrayToolTip::redraw() {
  ...
  QString text = QString("%1 down | %2 up")
                     .arg(formatSize(downt, true))
                     .arg(formatSize(upt, true));
  painter.setPen(Qt::black);
  painter.drawText(0, 0, WIDTH, OFFSET, Qt::AlignTop | Qt::AlignHCenter, text,
                   0);
