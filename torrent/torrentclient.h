...
public:
    ...
    static const char* state2string(State s);
    ...
    void setWantState(QMap<QString,bool> state);
    ...
    double ratio() const { return double(uploadedBytes())/double(downloadedBytes()); }
    ...
    // Settings
    static void setPortRange(int start,int end);
    static void setNumUploadSlots(int num);
